...
public class FileUpload
{
    ...
    */
   public static void upload( String ftpServer, String user, String password,String fileName, File source, String dirToUploadFile) throws MalformedURLException,
         IOException
   {
